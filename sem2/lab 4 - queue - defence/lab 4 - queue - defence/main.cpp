...
int main()
{
	...
	while (true)
	{
		...
		cout << "Выберите опцию: " << endl
			...
			<< "9. Преобразовать список в соответствии с защитой." << endl
		...
		case 9: // защита
		{
			...
			cout << "Какие ключи вы хотите переместить в конец очереди? Ваш выбор: ";
			cin >> buf;
			cout << "Полученная очередь с начала до конца:" << endl;

			list.elements_to_end(buf);
			list.show();
